...
public class EDFluidEntries {
    ...
    public static final FluidEntry<VirtualFluid> DRAGONS_BREATH_SODA = VirtualFluidFromItem.watery(ModItems.DRAGON_BREATH_SODA, 0xd16191)
            .register(),
            CHORUS_FLOWER_TEA = VirtualFluidFromItem.watery(ModItems.CHORUS_FLOWER_TEA, 0xa27da1)
                    .register(),
            CHORUS_FRUIT_WINE = VirtualFluidFromItem.watery(ModItems.CHORUS_FRUIT_WINE, 0xd39cd3)
                    .register(),
            CHORUS_FRUIT_MILK_TEA = VirtualFluidFromItem.milky(ModItems.CHORUS_FRUIT_MILK_TEA, 0xffa3ff)
                    .register(),
            CHORUS_FRUIT_BUBBLE_TEA = bubbleTea("chorus_fruit_bubble_tea", ModItems.BUBBLE_TEA, 0xffa3ff, 250)
                    .register();
