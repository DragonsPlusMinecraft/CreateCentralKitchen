...
public class FDItemEntries {
    ...
    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_EGG_SANDWICH = sequencedFood(ModItems.EGG_SANDWICH, Foods.BREAD),
    ...
    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_APPLE_PIE = sequencedFood(ModItems.APPLE_PIE, FoodValues.PIE_CRUST),
    ...
    public static final ItemEntry<ConditionedItem> CHOCOLATE_CAKE_SLICE = cakeSlice(Mods.ca("chocolate_cake"))
            .properties(prop -> prop.food(cakeSliceFood().nutrition(3).saturationMod(0.3F)
                    .effect(() -> new MobEffectInstance(RegistryObject
                            ...
                            .orElse(MobEffects.DIG_SPEED), 200), 1F)
                    .build()))
            .register(),
            ...
            YUCCA_CAKE_SLICE = cakeSlice(Mods.peculiars("yucca_cake"))
                    .properties(prop -> prop.food(cakeSliceFood().nutrition(1)
                            .effect(() -> new MobEffectInstance(RegistryObject
                                    ...
                                    .orElse(ModEffects.COMFORT.get()), 200), 1F)
                            .build()))
                    .register(),
            ALOE_CAKE_SLICE = cakeSlice(Mods.peculiars("aloe_cake"))
                    .properties(prop -> prop.food(cakeSliceFood().nutrition(1)
                            .effect(() -> new MobEffectInstance(RegistryObject
                                    ...
                                    .orElse(MobEffects.DAMAGE_RESISTANCE), 200), 1F)
                            .build()))
                    .register(),
            PASSION_FRUIT_CAKE_SLICE = cakeSlice(Mods.peculiars("passion_fruit_cake"))
                    .properties(prop -> prop.food(cakeSliceFood().nutrition(1)
                            .effect(() -> new MobEffectInstance(RegistryObject
                                    ...
                                    .orElse(MobEffects.DAMAGE_BOOST), 200), 1F)
                            .build()))
                    .register(),
            PUMPKIN_CAKE_SLICE = cakeSlice(Mods.seasonals("pumpkin_cake"))
                    .properties(prop -> prop.food(cakeSliceFood().nutrition(1)
                            .effect(() -> new MobEffectInstance(RegistryObject
                                    ...
                                    .orElse(ModEffects.NOURISHMENT.get()), 200), 1F)
                            .build()))
                    .register(),
