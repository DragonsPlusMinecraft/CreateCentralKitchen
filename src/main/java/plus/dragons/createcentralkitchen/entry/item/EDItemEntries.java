...
public class EDItemEntries {
    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_CHORUS_FRUIT_PIE = sequencedFood("chorus_fruit_pie", FoodValues.PIE_CRUST);

    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_CHORUS_FLOWER_PIE = sequencedFood("chorus_flower_pie", FoodValues.PIE_CRUST);
