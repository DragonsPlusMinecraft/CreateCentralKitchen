...
public class CRItemEntries {
    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_PORTOBELLO_BURGER = sequencedFood(CRItems.PORTOBELLO_BURGER, Foods.BREAD);

    public static final ItemEntry<SequencedAssemblyItem> INCOMPLETE_PORTOBELLO_QUICHE = sequencedFood(CRItems.PORTOBELLO_QUICHE, FoodValues.PIE_CRUST),
