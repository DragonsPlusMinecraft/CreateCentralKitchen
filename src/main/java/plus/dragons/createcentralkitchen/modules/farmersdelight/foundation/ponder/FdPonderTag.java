...
public class FdPonderTag extends PonderTag {
    ...
    public static final PonderTag FARMERS_DELIGHT = create("farmers_delight").item(FdItems.COOKING_GUIDE.get(), true, false)
            .defaultLang("Farmer's Delight Automation","Items and Components related to farmer's delight automation.").addToIndex();
