...
public class BasketScenes {
    ...
    public static void intro(SceneBuilder scene, SceneBuildingUtil util) {
        ...
        scene.overlay.showText(40)
            .text("Basket can collect transported items from belt.") // We do not use PonderLocalization. For registerText only
            .attachKeyFrame()
            .placeNearTarget()
        ...
        scene.overlay.showText(40)
            .text("Besides facing upwards, corresponding horizontal facing is also suitable.") // We do not use PonderLocalization. For registerText only
            .attachKeyFrame()
            .placeNearTarget()
            .pointAt(util.vector.topOf(0, 1, 2));
