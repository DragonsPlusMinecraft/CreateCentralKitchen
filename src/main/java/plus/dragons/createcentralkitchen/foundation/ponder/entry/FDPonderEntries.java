...
public class FDPonderEntries {
    public static final PonderEntry BASKET_INTRO = CentralKitchenPonders.create("basket/intro", BasketScenes::intro);

    public static final PonderEntry BASKET_BELT_INTERACTION = CentralKitchenPonders.create("basket/belt_interaction", BasketScenes::belt_interaction);

    public static final PonderEntry BLAZE_STOVE_INTRO = CentralKitchenPonders.create("blaze_stove/intro", BlazeStoveScenes::intro);

    public static final PonderEntry BLAZE_STOVE_CONFIGURE = CentralKitchenPonders.create("blaze_stove/automation", BlazeStoveScenes::automation);

    public static final PonderEntry BLAZE_STOVE_HEAT_SOURCE = CentralKitchenPonders.create("blaze_stove/heat_source", BlazeStoveScenes::heat_source);
