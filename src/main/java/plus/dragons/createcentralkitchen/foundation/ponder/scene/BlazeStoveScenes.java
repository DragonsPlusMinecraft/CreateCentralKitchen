...
//            .withItem(cookingGuide), 30);
        ...
        scene.overlay().showControls(util.vector().topOf(util.grid().at(1,1,1)), Pointing.DOWN, 30)
                        .rightClick().whileSneaking();
//        scene.overlay().showControls(new InputWindowElement(util.vector().centerOf(1, 1, 1), Pointing.DOWN)
//            .rightClick()
//            .withWrench()
//            .whileSneaking(), 30);// TODO 可能的问题
        scene.idle(40);
    }
    ...
    public static void automation(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showControls(util.vector().centerOf(3,1,1), Pointing.DOWN, 30).rightClick();
...
//            .rightClick(), 30);
    ...
    public static void heat_source(SceneBuilder builder, SceneBuildingUtil util) {
        CreateSceneBuilder scene = new CreateSceneBuilder(builder);
