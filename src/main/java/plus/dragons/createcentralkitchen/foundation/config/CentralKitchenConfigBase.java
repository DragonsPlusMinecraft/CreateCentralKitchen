...
public abstract class CentralKitchenConfigBase extends ConfigBase {
    ...
    protected static <V extends IForgeRegistryEntry<V>> List<RegistryObject<V>> createRegistryObjects(
    ...
    public class ConfigRegistryObjectList<V extends IForgeRegistryEntry<V>> extends ConfigList<String> implements ConfigReloadListener {
