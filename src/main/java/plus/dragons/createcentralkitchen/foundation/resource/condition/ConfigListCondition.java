...
public class ConfigListCondition implements ICondition {
    private static final ImmutableBiMap<String, CentralKitchenConfigBase.ConfigList<String>> CONFIGS = ImmutableBiMap.<String, CentralKitchenConfigBase.ConfigList<String>>builder()
