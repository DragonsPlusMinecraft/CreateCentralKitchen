...
@Mixin(CoffeeMiddleStemBlock.class)
public abstract class CoffeeMiddleStemBlockMixin extends BushBlock implements BonemealableBlock {

    public CoffeeMiddleStemBlockMixin(Properties pProperties) {
        super(pProperties);
    }
