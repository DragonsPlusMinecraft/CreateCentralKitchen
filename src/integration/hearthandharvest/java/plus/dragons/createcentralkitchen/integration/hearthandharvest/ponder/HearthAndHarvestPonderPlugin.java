...
public class HearthAndHarvestPonderPlugin {
    private static final ResourceLocation CASK = ModIntegration.HEARTHANDHARVEST.asResource("cask");

    public static void register() {
        CCKPonderPlugin.SCENES.add(HearthAndHarvestPonderPlugin::registerScenes);
        CCKPonderPlugin.TAGS.add(HearthAndHarvestPonderPlugin::registerTags);
    }
    ...
    private static void registerTags(PonderTagRegistrationHelper<ResourceLocation> helper) {
        helper.addToTag(AllCreatePonderTags.ARM_TARGETS).add(CASK);
        helper.addToTag(AllCreatePonderTags.HIGH_LOGISTICS).add(CASK);
    }
}
