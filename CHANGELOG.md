...
Final (hopefully) maintenance release for the Minecraft 1.20.1-1.x line, updated for Create 6.0.8.
...
* Restored 1.19.2-era processing recipes for Atmospheric, Autumnity, Corn Delight, End's Delight, Farmer's Delight, Farmer's Respite, Collector's Reap, Peculiars, Respiteful, Seasonals, and Upgrade Aquatic.
* Restored 1.19.2-era recipe unlock advancements for the manually maintained built-in packs.
* Restored the Blaze Stove loot table so breaking it returns the Blaze Burner.
* Restored 1.19.2-era Farmer's Delight sequenced assemblies, fixed the Hamburger assembly, and corrected the Mutton Wrap recipe identifier.
...
* Corrected a few translation.
* Corrected the packaged project metadata and translation contribution links.
