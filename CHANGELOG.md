...
### Remove
* Removed Kelaidoscope Cookery Compat since there are 2 mods `Kaleidoscope Compat` and `Kaleidoscope Cookery: Automation` providing much more complete integration.
